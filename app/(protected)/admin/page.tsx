    ...
    <>
      ...
      <div className="flex flex-col items-center justify-start py-8 px-4 sm:py-12">
        ...
        <div className="w-full max-w-2xl mb-8 sm:mb-12">
          <h1 className="text-3xl sm:text-4xl font-bold text-foreground text-center mb-2">Find Drivers</h1>
          <p className="text-center text-muted-foreground text-sm sm:text-base">Search driver by name, address or license #</p>
        </div>
          ...
          {filteredProfiles.length > 0 ? (
            ...
            <div className="text-center py-8">
              <p className="text-muted-foreground">
                {query ? "No profiles found matching your search" : "Start typing to search"}
              </p>
            </div>
          )}
        </div>
