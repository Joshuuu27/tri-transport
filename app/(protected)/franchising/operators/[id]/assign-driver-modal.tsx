...
export default function AssignDriverModal({
  ...
  const [selectedDriver, setSelectedDriver] = useState(
    vehicle.assignedDriverId || "unassign"
  );
  ...
  const handleAssign = async () => {
    if (!selectedDriver || selectedDriver === "unassign") {
      // Handle unassign - empty string
      try {
        setIsLoading(true);
  ...
  const selectedDriverName = selectedDriver !== "unassign" 
